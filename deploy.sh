...
git remote add github_remote https://github.com/siruguri/lagged_site_reader.git 2>/dev/null || git remote set-url github_remote https://github.com/siruguri/lagged_site_reader.git
